...
<div class="col-lg-8">
        		<div class="post_container_title">
		    		...
		    		<p>
		    		    ...
		    		    <span><i class="bi bi-chat-square-text"></i><a href="<?php $this->permalink() ?>#post_comment_anchor">
            ...
            <?php endif; ?>
				...
				<div class="next_prev_posts">
				    ...
				    <div class="prev_next_box nav_previous">
				        <a href="<?php echo $prevPost->permalink; ?>" title="<?php echo $prevPost->title; ?>" rel="prev" style="background-image: url(<?php echo $prevThumbnail; ?>);">
				    ...
				    <div class="prev_next_box nav_next">
				        <a href="<?php echo $nextPost->permalink; ?>" title="<?php echo $nextPost->title; ?>" rel="next" style="background-image: url(<?php echo $nextThumbnail; ?>);">
				            <div class="prev_next_info">
				                <small>下一篇</small>
