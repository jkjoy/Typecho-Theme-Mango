...
try {
    ...
    $linksBySort = [];
    error_log('Mango links table query failed: ' . $error->getMessage());
}

$defaultLinkImage = rtrim((string)$options->themeUrl, '/') . '/assets/img/nopic.svg';
    ...
    <div class="post_container">
        ...
        <div class="mango-links">
            <?php if (!$linksTableAvailable): ?>
                <div class="mango-empty">未检测到可用的 links 数据表，请先安装并启用 Links 插件完成初始化</div>
